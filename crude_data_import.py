...
HISTORICAL_PATCH_START_DATE = os.getenv("HISTORICAL_PATCH_START_DATE", "2026-06-02").strip()
HISTORICAL_PATCH_END_DATE = os.getenv("HISTORICAL_PATCH_END_DATE", "2026-06-04").strip()
