...
Total input rows after vertical union: 83,027
Total input columns before pruning: 66
Columns pruned: 4

## Dropped columns
  - currency_native: only 1 unique non-null value(s) across 83027 rows → DROP
  - source_timezone: only 1 unique non-null value(s) across 83027 rows → DROP
